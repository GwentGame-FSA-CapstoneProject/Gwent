...
import GameHandler from "../src/helpers/GameHandler";
...
class PlayerHud extends React.Component {
  ...
  render() {
    ...
    console.log("game", this.playerHand);
    return (
      <div className="container">
        <div className="playersection">
          <h1>PLAYER A</h1>
          <h2>Round wins: {this.props.player1RoundWins} </h2>
          <p>Player image</p>
        ...
        <div className="playersection">
          <h1>PLAYER B</h1>
          <h2>Round wins: {this.props.player2RoundWins} </h2>
          <p>Player image</p>
          <p>Total Strength:7</p>
          <p>Player Hand:3</p>
        </div>
